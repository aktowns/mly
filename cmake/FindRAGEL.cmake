...
#   RAGEL_TARGET(MyMachine 11489072machine.rl ${CMAKE_CURRENT_BINARY_DIR}/machine.cc)
...
if(RAGEL_EXECUTABLE)
    ...
    macro(RAGEL_TARGET Name Input Output)
        set(RAGEL_TARGET_usage
                "RAGEL_TARGET(<Name> <Input> <Output> [DEPENDS <Depends>] [COMPILE_FLAGS <string>]")
        if(${ARGC} GREATER 3)
            if(${ARGC} EQUAL 5)
                if("${ARGV3}" STREQUAL "COMPILE_FLAGS")
                    set(RAGEL_EXECUTABLE_opts  "${ARGV4}")
                    separate_arguments(RAGEL_EXECUTABLE_opts)
                elseif("${ARGV3}" STREQUAL "DEPENDS")
                    set(RAGEL_DEPENDS "${ARGV4}")
                    separate_arguments(RAGEL_DEPENDS)
                else()
